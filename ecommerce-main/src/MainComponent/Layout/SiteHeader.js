...
const SiteHeader = (cartCount) => {
  ...
  useEffect(() => {
    const isInsideSearchBox = (e) => {
      if (searchBoxRef.current && searchIconRef.current) {
        if (
    ...
    document.addEventListener("click", isInsideSearchBox);

    return () => {
      document.removeEventListener("click", isInsideSearchBox);
    };
  }, []);
  ...
  const updatedSubCat = subcatData.reduce((acc, sub) => {
    if (acc[sub.cat_id]) {
      acc[sub.cat_id].push(sub);
    } else {
      acc[sub.cat_id] = [sub];
    }
    return acc;
                ...
                <div className="row">
                      ...
                      <nav id="main-navigation">
                        <ul id="menu-main-menu" className="menu">
                          <li className="level-0 menu-item  mega-menu">
                            {/* current-menu-item it is className for active */}
                            <Link>
                  ...
                  <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 header-right">
                    <div className="header-page-link">
                      ...
                      <div className="search-box" ref={searchIconRef}>
                        <div className="search-toggle" onClick={handlesearch}>
                          <i className="icon-search"></i>
                        </div>
                      </div>
                ...
                <div className="col-12 text-center">
                  <ul className="list-unstyled">
                    <div className="d-flex p-0">
                      <div className="col-2" onClick={closeSidebar}>
                        <i
                      ...
                      <div className="col-10 m-0 p-0" >
                        ...
                        >
                          <h5 className="mx-auto text-center fw-bold m-0">
                            Furniture
                          </h5>
                        </Link>
                      </div>
                  ...
                  <ul className="list-unstyled">
                    <div className="d-flex p-0">
                      ...
                      <div className="col-10">
                        ...
                        >
                          <h5 className="mx-auto text-center">Decor</h5>
                        </Link>
                      </div>
                    </div>
                  ...
                  <ul className="list-unstyled">
                    <div className="d-flex p-0">
                      ...
                      <div className="col-10">
                        ...
                        >
                          <h5 className="mx-auto text-center">TableWare</h5>
                        </Link>
                      </div>
                    </div>
                    <hr />
